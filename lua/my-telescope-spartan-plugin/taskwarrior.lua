...
---@field taskwarrior_init fun(ext_config: table): fun(opts?: table)
local M = {}
...
---Initialize the taskwarrior picker
---@param ext_config table Extension configuration from telescope setup
---@return fun(opts?: table) picker function
M.taskwarrior_init = function(ext_config)
    -- TODO: Enable user config for keymaps
    -- default_action_maps = ext_config.maps.actions or default_action_maps
    _ = ext_config -- silence unused warning
                ...
                finder = finders.new_async_job({
                    ...
                    entry_maker = function(entry)
                        ...
                        return {
                            ...
                            ordinal = (parsed_data.project or "")
                                .. ":"
                                .. parsed_data.description
                                .. ":"
                                .. parsed_data.status
                                .. (parsed_data.tags and ":" .. table.concat(parsed_data.tags, ":") or ""),
                        }
                    end,
                }),
